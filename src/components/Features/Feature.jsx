        ...
        <>
            {
                ...
                // true
                <div dir={lang==="en"? "ltr": "rtl"} className={`Features ${lang==="en"? "font-mangiola": "font-vazir-light"} grid grid-cols-3 gap-2 md:gap-4 lg:gap-6 xl:gap-8 w-full`}>
                    {feacher.map(feacher => (
                ...
                // false
                <>   
                <div dir={lang==="en"? "ltr": "rtl"} className={`Features ${lang==="en"? "font-mangiola": "font-vazir-light"} flex justify-center items-start gap-x-2 md:gap-x-4 lg:gap-x-6 xl:gap-x-8 w-full`}>
