...
export default function Sidebar({lang}) {
    ...
    return (
        <div dir={result[0]} className={`Sidebar flex w-[13%] ${location.pathname=="/my-react-site/admin"? "hover:w-1/5`" : ""} flex-col justify-start items-start gap-y-6 p-6 shadow-md border rounded-lg transition-[width] duration-1000`}>
