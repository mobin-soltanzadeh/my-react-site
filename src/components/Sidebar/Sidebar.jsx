...
export default function Sidebar({lang}) {
    ...
    return (
        <div dir={result[0]} className={`Sidebar basis-[13%] hover:basis-1/5 flex flex-col justify-start items-start gap-y-6 p-6 shadow-md border rounded-lg transition-[flex] duration-1000`}>
