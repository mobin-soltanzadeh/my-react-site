...
export default function ResumModal(props) {
    ...
    return (
        <div className={`fixed ResumModal top-0 right-0 left-0 ${displayModal} justify-center items-center w-screen h-screen bg-zinc-400/40 backdrop-blur-sm z-50`}>
            <div className="relative w-auto min-w-[700px] max-w-[1000px] px-12 py-10 bg-gray-300 rounded-lg transition-[width] duration-1000">
                <button onClick={closeModal} className="absolute top-6 right-3 w-9 h-9 p-1 hover:rotate-[360deg] hover:scale-150 transition-transform duration-1000 z-50"> <FaXmark className="w-full h-full text-zinc-700 hover:text-zinc-900" /> </button>
                <Swiper 
