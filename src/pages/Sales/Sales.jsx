...
export default function Sales() {
    const salesColmuns = [
        ...
        {field: "productName", headerName: "Type", headerAlign: "center", width: 150, align: "center", cellClassName: (params) => 'text-gray-900 dark:text-gray-200' },
        {
            field: "product-name", headerName: "Product Name", width: 250, headerAlign: "center", align: "center",
            renderCell: params => {
                return (
        ...
        {field: "salesId", headerName: "Sell - Id", width: 150, headerAlign: "center", cellClassName: (params) => 'text-gray-900 dark:text-gray-200' },
        {field: "price", headerName: "Price", headerAlign: "center", width: 150, align: "center", cellClassName: (params) => 'text-gray-900 dark:text-gray-200 flex justify-center items-center w-full' },
        {
